...
while True:
    ...
    if input == 0:
        ...
        if l1[7] != 'X' and l1[7] != 'O':
            l1.pop(7)
            l1.insert(7, 'X')
        elif l2[7] != 'X' and l2[7] != 'O':
            l2.pop(7)
            l2.insert(7, 'X')
        elif l3[7] != 'X' and l3[7] != 'O':
            l3.pop(7)
            l3.insert(7, 'X')
        elif l4[7] != 'X' and l4[7] != 'O':
            l4.pop(7)
            l4.insert(7, 'X')
        elif l5[7] != 'X' and l5[7] != 'O':
            l5.pop(7)
            l5.insert(7, 'X')
        elif l6[7] != 'X' and l6[7] != 'O':
            l6.pop(7)
            l6.insert(7, 'X')
